...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th2 13, 2018 lúc 04:21 PM
...
(1, 'Hieu Minh', 'minhhieuuet@gmail.com', '$2y$10$H0NYtVjxLt0oe.3D1g9t/Opf2U8V4w3faSZYbnQIMzh5PVt.5VeH6\r\n$2y$10$H0NYtVjxLt0oe.3D1g9t/Opf2U8V4w3faSZYbnQIMzh5PVt.5VeH6\r\n$2y$10$H0NYtVjxLt0oe.3D1g9t/Opf2U8V4w3faSZYbnQIMzh5PVt.5VeH6\r\n$2y$10$H0NYtVjxLt0oe.3D1g9t/Opf2U8V4w3faSZYbnQIMzh5PVt.5VeH6', NULL, NULL, NULL);

-- --------------------------------------------------------

--
-- Cấu trúc bảng cho bảng `baby_info`
--
...
CREATE TABLE `baby_info` (
  ...
  `sex` varchar(2) COLLATE utf8_unicode_ci NOT NULL DEFAULT 'm',
  `birthday` datetime NOT NULL DEFAULT '0000-00-00 00:00:00',
  `father` varchar(50) COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  `mother` varchar(50) COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  `birth_address` varchar(255) COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
...
--
-- Cấu trúc bảng cho bảng `baby_photo`
--
...
CREATE TABLE `baby_photo` (
  ...
  `take_at` datetime NOT NULL DEFAULT '0000-00-00 00:00:00',
  `deleted_at` timestamp NULL DEFAULT NULL,
  `created_at` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00',
  `updated_at` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00'
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE `bills` (
  ...
  `note` varchar(500) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT ' ',
...
(33, 11, '2018-02-12', 510000, 'COD', NULL, '2018-02-12 10:57:26', '2018-02-12 10:57:26');
...
(19, 29, 24, 1, 180000, '2018-02-12 09:24:43', '2018-02-12 09:24:43'),
(20, 29, 50, 2, 120000, '2018-02-12 09:24:43', '2018-02-12 09:24:43'),
(21, 30, 24, 1, 180000, '2018-02-12 09:25:22', '2018-02-12 09:25:22'),
(22, 30, 50, 2, 120000, '2018-02-12 09:25:22', '2018-02-12 09:25:22'),
(23, 33, 4, 1, 160000, '2018-02-12 10:57:26', '2018-02-12 10:57:26'),
(24, 33, 15, 1, 350000, '2018-02-12 10:57:26', '2018-02-12 10:57:26');
...
('2014_07_01_213057_create_password_reminders_table', 1),
('2014_08_08_164257_mcc_action_log_table', 1),
('2014_08_08_164833_mcc_menu_table', 1),
('2014_08_08_164844_mcc_role_table', 1),
('2014_08_08_164854_mcc_user_table', 1),
('2014_09_01_135954_baby_table', 1),
('2014_09_01_174721_photo_table', 1);
...
(9, 'Bánh Crepe Sầu riêng và Dứa', 5, NULL, 160000, 150000, 'ULwk8-Nature_00009.jpg', 'hộp', 0, '2016-10-26 03:00:16', '2018-02-05 09:30:57'),
...
(65, 'Bánh chim', 5, '<p>B&aacute;nh ngon vl</p>', 10000, 2300, 'kVMPw-[Bluebee-uet.com]1472612027toan-roi-rac-de-1-phan-hong-thai-2013-2014.jpg', NULL, 0, '2018-02-05 06:52:25', '2018-02-05 06:52:25'),
(66, 'Bành gà', 7, '<p>B&aacute;nh h&igrave;nh con g&agrave; rất đẹp</p>', 90000, 50000, '1JZWL-Nature_00002.jpg', NULL, 0, '2018-02-05 06:57:33', '2018-02-05 06:57:33');
...
CREATE TABLE `slide` (
  ...
  `desctiption` varchar(1000) DEFAULT NULL
...
INSERT INTO `slide` (`id`, `link`, `image`, `desctiption`) VALUES
(1, 'Aditii', 'banh.png', 'Đem đến cho bạn những loại bánh cao cấp nhất.'),
(2, 'Luôn giao hàng đúng hạn', 'banh2.png', 'Dù có cách xa ngàn cây sô,dù có phải xẻ núi ngăn sông, Aditii cũng sẽ giao hàng đùng hạn cho bạn!'),
(3, '', 'banner3.jpg', NULL),
(4, '', 'banner4.jpg', NULL);
...
(5, 'Bánh crepe', 'Crepe là một món bánh nổi tiếng của Pháp, nhưng từ khi du nhập vào Việt Nam món bánh đẹp mắt, ngon miệng này đã làm cho biết bao bạn trẻ phải “xiêu lòng”', 'Ubz0_31365-banh-bong-lan-trung-muoi-1.jpg', '2016-10-28 04:00:00', '2017-08-28 17:10:53'),
...
(15, 'Bánh tarlet', 'Nếu từng bị mê hoặc bởi các loại tarlet ngọt thì chắn chắn bạn không thể bỏ qua những loại tarlet mặn. Ngoài hình dáng bắt mắt, lớp vở bánh giòn giòn cùng với nhân mặn như thịt gà, nấm, thị heo ,… của bánh sẽ chinh phục bất cứ ai dùng thử.', '5roj_chocolate_caramel_tart_main1.jpg', '2017-08-28 16:31:14', '2017-08-28 17:10:33');
...
INSERT INTO `users` (`id`, `full_name`, `email`, `password`, `phone`, `address`, `remember_token`, `created_at`, `updated_at`, `rank`, `block`) VALUES
(11, 'HIeu Do', 'minhhieu@gmail.com', '$2y$10$cEJ.4oQpBRQN7OJXIwso2eUTAX2CwyqeB3tUabHMSQ2.XJ1Zsm6gi', '0963871598', NULL, '1VgWaTSJqjDd7HjHPIxI3xzHJRrkrvuLRIKutXWvXx006akuyxSuy6USW5fK', NULL, NULL, 1, b'0'),
(12, 'Do Minh Hieu', 'minhminh@gmail.com', '$2y$10$g7LucYSGCMtBrV0Ta6uDauvFhxbbR4W.OwIPEVzImiFPtTeGMolFC', '1234563', 'Kim mã', 'pGZozAlINHlal4bzEnz2CI5qR6daUYSEMJiuSXyV6MBBuwDG7zcWlEpnoTVk', NULL, NULL, 1, b'0'),
(13, 'Minh Hiếu', 'noproname1998@gmail.com', '$2y$10$luGNna6RMKLzKUQvuYdb7eaFv5y1ALtZNuvlf.Vz518hzwZbK07ym', NULL, NULL, NULL, '2018-02-08 08:18:04', '2018-02-08 08:18:04', 0, b'0');
...
--
-- Chỉ mục cho bảng `baby_info`
--
ALTER TABLE `baby_info`
  ADD PRIMARY KEY (`id`);

--
-- Chỉ mục cho bảng `baby_photo`
--
ALTER TABLE `baby_photo`
  ADD PRIMARY KEY (`id`);
...
ALTER TABLE `password_reminders`
  ADD KEY `password_reminders_username_index` (`username`),
...
--
-- AUTO_INCREMENT cho bảng `baby_info`
--
ALTER TABLE `baby_info`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT cho bảng `baby_photo`
--
ALTER TABLE `baby_photo`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
