...
class AdminController extends Controller
{
    ...
    {
        Bills::destroy($id);
        $billdetail=BillDetails::where('id_bill',$id);
        $billdetail->delete();
        return back()->with('thongbao','Xóa thành công đơn hàng');
    }
    //Khach hang
    ...
    public function nguoidung()
    {
        ...
        return view('admin.nguoidung',['nguoidung'=>$nguoidung]);
    }
    ...
    public function xoaNguoiDung($id)
    {
        ...
        {
        return back()->with('thongbao','Không thể xóa admin');
        }
        
        return back()->with('xoa','Xóa thành công người dùng '.$username->full_name);
    }

    public function blockNguoiDung($id)
    {
        $user=  User::find($id);
        if ($user->block=='true')
